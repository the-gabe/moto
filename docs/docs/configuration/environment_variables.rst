...
+-------------------------------+----------+-----------+-------------------------------------------------------------------------------------------------+
| MOTO_SES_SMTP_RELAY           | str      |           | See :ref:`ses`.                                                                                 |
+-------------------------------+----------+-----------+-------------------------------------------------------------------------------------------------+
| MOTO_DOCKER_LAMBDA_IMAGE\_     | str      |           | Per-runtime form of MOTO_DOCKER_LAMBDA_IMAGE, e.g.                                              |
| {RUNTIME}                     |          |           | MOTO_DOCKER_LAMBDA_IMAGE_PYTHON3_12. Checked before the plain variable.                          |
+-------------------------------+----------+-----------+-------------------------------------------------------------------------------------------------+
